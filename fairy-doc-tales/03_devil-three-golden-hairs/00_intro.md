...
```mermaid
graph TB
    A[King's Quest] --> B[Journey Begins]
    B --> C[Meet Ferryman]
    C --> D[Town with Dry Fountain]
    D --> E[Town with Dead Tree]
    E --> F[Arrive at Hell]
    F --> G[Grandmother Helps]
    G --> H[Get First Hair]
    H --> I[Get Second Hair]
    I --> J[Get Third Hair]
    J --> K[Learn Riddle Answers]
    K --> L[Return Journey]
    L --> M[Solve Fountain Riddle]
