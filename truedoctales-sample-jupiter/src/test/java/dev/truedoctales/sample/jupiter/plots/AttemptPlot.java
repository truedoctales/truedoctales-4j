 ...
 *
 * <p>Models the futile attempts teams make to resolve business risks without the right tools — and
 * the successful resolutions that become possible once they have the right skills.
 */
@Plot("Attempt")
public class AttemptPlot {
  ...
  @Step(
      value = "Fails",
      description =
          "Records an attempt to resolve a business risk that fails. "
              + "The approach is insufficient without the right structural solution.")
  public void fails(
      @Variable(value = "teamMember", description = "Who is attempting the resolution")
          String teamMember,
  ...
  @Step(
      value = "Succeeds with skill",
      description =
          "A team member resolves a business risk by applying the correct skill. "
  ...
  public void succeedsWithSkill(
      ...
      @Variable(value = "outcome", description = "Expected outcome — must be RESOLVED")
          String outcome) {
