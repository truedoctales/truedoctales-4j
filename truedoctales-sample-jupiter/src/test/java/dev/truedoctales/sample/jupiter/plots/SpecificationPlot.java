 ...
 *
 * <p>A feature without a concrete, verifiable example is not a specification. It is a wish. This
 * plot makes the difference visible and executable.
 *
 * <p>Use {@code Has no examples} in failure stories to show missing specifications. Use {@code Add
 * example} + {@code Has examples} in success stories to show the fix.
 */
@Plot("Specification")
public class SpecificationPlot {
  ...
  @Step(
      value = "Add example",
      description =
          "Adds a concrete, verifiable example to a feature specification. "
  ...
  @Step(
      value = "Has examples",
      description =
          "Asserts that the feature has at least one concrete example. "
  ...
  @Step(
      value = "Has no examples",
      description =
          "Asserts that the feature has no concrete examples. "
  ...
  public void exampleCountIs(
    ...
    Assertions.assertEquals(
        count,
        specificationService.exampleCount(feature),
