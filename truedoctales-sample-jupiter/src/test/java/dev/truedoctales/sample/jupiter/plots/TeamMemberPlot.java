 ...
 *
 * <p>Models the people on a software delivery team — their roles, skills,
 * and the habits that quietly undermine every sprint.
 */
@Plot("Team Member")
public class TeamMemberPlot {
  ...
  public void teamMemberExists(
    ...
    Assertions.assertTrue(heroService.exists(name),
        "Team member '" + name + "' should exist");
  }

  @Step(value = "Grant skill",
      description = "Adds a skill to a team member's profile.")
  public void grantSkill(
    ...
    Assertions.assertTrue(heroService.grantSkill(teamMember, skill),
        "Team member '" + teamMember + "' must exist");
  }

  @Step(value = "Has skill",
      description = "Asserts that the team member has the specified skill.")
  public void hasSkill(
      @Variable(value = "teamMember", description = "Name of the team member") String teamMember,
      @Variable(value = "skill", description = "Expected skill") String skill) {
    Assertions.assertTrue(heroService.hasSkill(teamMember, skill),
        "Team member '" + teamMember + "' should have skill '" + skill + "'");
  }

  @Step(value = "Grant weakness",
  ...
  public void grantWeakness(
    ...
    Assertions.assertTrue(heroService.grantWeakness(teamMember, weakness),
        "Team member '" + teamMember + "' must exist");
  }

  @Step(value = "Has weakness",
  ...
  public void hasWeakness(
    ...
    Assertions.assertTrue(heroService.hasWeakness(teamMember, weakness),
        "Team member '" + teamMember + "' should have weakness '" + weakness + "'");
  }

  @Step(value = "Trophy earned",
      description = "Awards a recognition trophy to the team member.")
  public void trophyEarned(
      @Variable(value = "teamMember", description = "Name of the team member") String teamMember,
      @Variable(value = "trophy", description = "Trophy to award") String trophy) {
    Assertions.assertTrue(heroService.awardTrophy(teamMember, trophy),
        "Team member '" + teamMember + "' must exist");
  }
}
